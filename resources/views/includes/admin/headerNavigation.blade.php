<nav class="navbar page-header">
    ...
    <a class="navbar-brand" href="{{ url('/') }}">
        <img src="{{asset('admin/assets/imgs/laravel-logo.png')}}" alt="logo" style="width: 50%">
    </a>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        @if(Auth::user()->author == true)
            <a href="{{route('authorNewPost')}}" class="btn btn-primary" style="margin-right: 10px">Create Post </a>
        @endif
